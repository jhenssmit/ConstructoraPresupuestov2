...
<ol class="breadcrumb mb-4">
    <li class="breadcrumb-item active">Materiales Paredes</li>
</ol>
<button class="btn btn-primary mb-2" type="button" onclick="frmMatePiso();"><i class="fas fa-plus"></i></button>
<table class="table table-light" id="tblMatePared">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="frmMatePiso">
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="hidden" id="id" name="id">
                        <input value="3" type="hidden" id="id_elemento" name="id_elemento">
