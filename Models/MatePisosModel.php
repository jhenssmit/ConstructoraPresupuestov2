<?php
class MatePisosModel extends Query
{
    ...
    public function getMatePisos()
    {
        $sql = "SELECT m.*, e.nombre as id_elemento FROM materiales m INNER JOIN elementos e WHERE e.id_elemento=m.id_elemento and m.id_elemento=1";
